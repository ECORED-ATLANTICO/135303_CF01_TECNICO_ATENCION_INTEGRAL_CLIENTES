...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .p-4.bgr_4  
          .row.justify-content-around.align-items-center
            .d-none.d-lg-block.col-lg-3
              figure
                img(src="@/assets/curso/tema4/1.png", alt="Imagen de acompañamiento")
            .col-lg-7
              ol.lista-ol--cuadro
                li.d-flex 
                  .lista-ol--cuadro__vineta.lista-ol--cuadro__vineta--secundario
                    span a
                  | Tener conocimiento de los perfiles de los clientes.
                li.d-flex 
                  .lista-ol--cuadro__vineta.lista-ol--cuadro__vineta--secundario
                    span b
                  | Disponer de bases de datos de los clientes.
                li.d-flex 
                  .lista-ol--cuadro__vineta.lista-ol--cuadro__vineta--secundario
                    span c
                  | Desarrollar investigaciones sobre los clientes, buscando conocer sus necesidades.
                li.d-flex 
                  .lista-ol--cuadro__vineta.lista-ol--cuadro__vineta--secundario
                    span d
                  | Evaluar el nivel de satisfacción con los servicios prestados.
                li.d-flex 
                  .lista-ol--cuadro__vineta.lista-ol--cuadro__vineta--secundario
                    span e
                  | Implementar constantemente auditorías de los servicios.
                li.d-flex 
                  .lista-ol--cuadro__vineta.lista-ol--cuadro__vineta--secundario
                    span f
    ...
    .bg_grad-10.mb-5
      .row.justify-center
        .col-12.col-md-8.col-lg-5.col-xl-4
          figure
            img(src='@/assets/curso/tema4/t4-13.svg' alt='AvatarTop')
      ...
      .tarjeta.tarjeta--blanca.position-relative.p-4.pt-5.z-2.my-5
        SlyderA(tipo="b")
          .row.z-2.justify-content-center.align-items-center
            .col-lg-6
              h4.mb-4 Saludo
              p Describe la forma en que se debe realizar el saludo, teniendo presente la actitud del colaborador para con el cliente y el acercamiento haciendo uso del guion establecido por la organización, hacer contacto visual con el cliente.
            .col-10.col-lg-5
              figure
                img(src='@/assets/curso/tema4/6.png', alt='Imagen de acompañamiento')
          .row.z-2.justify-content-center.align-items-center
            .col-lg-6
              h4.mb-4 Comportamiento
              p Describe las acciones, comportamiento y actitudes que se deben tener durante la atención, por parte del personal de atención.
            .col-10.col-lg-5
              figure
          ...
          .row.z-2.justify-content-center.align-items-center
            .col-lg-6
              h4.mb-4 Despedida
              p Se establece la forma de despedida, haciendo uso del protocolo y del guion establecido para el cierre del contacto.
            .col-10.col-lg-5
              figure
    ...
    .row.mb-5.bgr_7.p-4.p-lg-5
      .col-12.col-lg-6(data-aos="fade-right")
        ul.lista-ul--color
          li.d-flex 
            i.fas.fa-check
            p El teléfono se debe responder al sonar entre una y tres veces.
          li.d-flex 
            i.fas.fa-check
            p La forma de saludar al interlocutor.
          li.d-flex 
            i.fas.fa-check
            p La presentación de quien responde la llamada.
          li.d-flex 
            i.fas.fa-check
            p Interrogar al cliente sobre la situación en la que se le puede ayudar.
          li.d-flex 
            i.fas.fa-check
            p Siempre se debe tratar al cliente de usted.
          li.d-flex 
            i.fas.fa-check
            p Si se pone al cliente a esperar en la línea, se le debe informar cuanto tiempo promedio debe esperar.
          li.d-flex 
            i.fas.fa-check
      ...
      .col-12.col-lg-6(data-aos="fade-left")
        ul.lista-ul--color
          li.d-flex 
            i.fas.fa-check
            p En caso de que el cliente requiera una persona que no esté presente en la compañía ofrezca la ayuda si es posible, de lo contrario, tome nota del mensaje o transfiera la llamada a quien pueda prestar ayuda.
          li.d-flex 
            i.fas.fa-check
            p La llamada se debe responder en un tono adecuado y con buena vocalización.
          li.d-flex 
            i.fas.fa-check
            p Si la llamada se transfiere a otra persona, informe a quien la recibe quien llama y cuál es el motivo de la llamada.
          li.d-flex 
            i.fas.fa-check
            p Para terminar la llamada agradezca al cliente por la llamada y que espera atenderle nuevamente.
          li.d-flex 
            i.fas.fa-check
            p Espere que el cliente termine la llamada y no le corte la llamada si este aún está hablando.

    .row.align-items-center.justify-content-center.mb-4.mb-lg-5
      .d-none.d-lg-block.col-lg-1
        img.d-none.d-lg-flex(src="@/assets/curso/tema4/waves-2.svg", style="max-width: 90px").mx-auto
      .col-lg-9
        p.mb-0 En ocasiones se encuentra que, pese al esfuerzo realizado por los clientes internos de la organización, el cliente externo manifiesta inconformidad y presenta una queja, por ello siempre se debe escuchar con amabilidad, respeto y cortesía, incluso el cliente interno debe conservar la serenidad y profesionalismo pese a que en ocasiones el cliente externo se manifieste incomprendido e incómodo. 
    ...
    .row.justify-content-center.tema-4.mb-4.mb-lg-5
      .col-xl-10
        TabsA.color-primario
          .tarjeta.bgr_7.p-4.p-lg-5(titulo="La empresa a los clientes")
    ...
    figure.mb-5
      .video.mb-2
        iframe(width="560" height="315" src="https://www.youtube.com/embed/Z9AoxQ3nxYE" title="Momentos de verdad" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .bg_grad-13.mb-5
      .row.justify-content-center
        .col-12.col-lg-5
          figure.justify-center
            img.img420(src='@/assets/curso/tema4/t4-40.svg', alt='Texto que describa la imagen')
        .col-12.col-lg-6.p-5
    ...
    datosSlyder: [
      {
        titulo: 'Saludo',
        texto:
          'Describe la forma en que se debe realizar el saludo, teniendo presente la actitud del colaborador para con el cliente y el acercamiento haciendo uso del guion establecido por la organización, hacer contacto visual con el cliente..',
        imagen: require('@/assets/curso/tema4/t4-26.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        titulo: 'Comportamiento',
        texto:
          'Describe las acciones, comportamiento y actitudes que se deben tener durante la atención, por parte del personal de atención.',
      ...
      },
      {
        titulo: 'Despedida',
        texto:
          'Se establece la forma de despedida, haciendo uso del protocolo y del guion establecido para el cierre del contacto.',
